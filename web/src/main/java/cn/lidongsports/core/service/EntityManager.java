package cn.lidongsports.core.service;

import cn.lidongsports.core.orm.Page;
import cn.lidongsports.core.orm.PageRequest;
import cn.lidongsports.core.orm.PropertyFilter;
import cn.lidongsports.core.orm.StringPropertyFilter;
import cn.lidongsports.core.orm.hibernate.HibernateDao;
...
public abstract class EntityManager<T, ID extends Serializable> {
	...
	public void remove(String ids) {
		...
		getEntityDao().createQuery("delete from "+entityClass.getSimpleName()+" where id in "+cn.lidongsports.core.util.StrUtils.idStrToIds(ids)).executeUpdate();
	}
	public void remove(String[] ids) {
