...
import cn.lidongsports.system.entity.Menu;
import cn.lidongsports.system.service.MenuService;
...
public class MenuAction {
	...
	@ResponseBody
	public void listMyMenu(HttpServletRequest request, HttpServletResponse response) {
		HttpSession session = request.getSession();
		AppUser currUser = (AppUser) session.getAttribute("USER");
		// 注意顺序问题
		List<Menu> list = menuService.listMyMenu(currUser);
